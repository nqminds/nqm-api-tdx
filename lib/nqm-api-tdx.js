(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("debug"), require("isomorphic-fetch"), require("base-64"));
	else if(typeof define === 'function' && define.amd)
		define("nqm-api-tdx", ["debug", "isomorphic-fetch", "base-64"], factory);
	else if(typeof exports === 'object')
		exports["nqm-api-tdx"] = factory(require("debug"), require("isomorphic-fetch"), require("base-64"));
	else
		root["nqm-api-tdx"] = factory(root["debug"], root["isomorphic-fetch"], root["base-64"]);
...
exports.waitForIndex = exports.TDXApiError = exports.setDefaults = exports.handleError = exports.checkResponse = exports.buildQueryRequest = exports.buildDatabotInstanceRequest = exports.buildDatabotHostRequest = exports.buildCommandRequest = undefined;
...
var buildCommandRequest = function buildCommandRequest(command, data, contentType, async) {
  ...
  return new _isomorphicFetch2.default.Request(this.config.commandServer + "/" + commandMode + "/" + command, {
    method: "POST",
    mode: "cors",
    headers: new Headers({
...
var buildDatabotHostRequest = function buildDatabotHostRequest(command, data) {
  return new _isomorphicFetch2.default.Request(this.config.databotServer + "/host/" + command, {
    method: "POST",
    mode: "cors",
    headers: new Headers({
      "Authorization": "Bearer " + this.accessToken,
...
var buildQueryRequest = function buildQueryRequest(endpoint, filter, projection, options) {
  ...
  return new _isomorphicFetch2.default.Request("" + this.config.queryServer + query, {
    method: "GET",
    mode: "cors",
    headers: new Headers({
      "Authorization": "Bearer " + this.accessToken,
...
var buildDatabotInstanceRequest = function buildDatabotInstanceRequest(endpoint) {
  return new _isomorphicFetch2.default.Request(this.config.databotServer + "/instance/" + endpoint, {
    method: "GET",
    mode: "cors",
    headers: new Headers({
      "Authorization": "Bearer " + this.accessToken,
...
var setDefaults = function setDefaults(config) {
  ...
  log("using hosts: command %s, databot %s, query %s, auth %s", config.commandServer, config.databotServer, config.queryServer, config.tdxServer);
};
  ...
  return this.getResource(resourceId).then(function (resource) {
    ...
    if (!checkResult) {
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          log("trying again");
          resolve(waitForResource.call(_this, resourceId, check, retryCount + 1, maxRetries));
        }, pollingInterval);
      });
    } else {
      return resource;
...
var TDXApi = function () {
  ...
  _createClass(TDXApi, [{
    key: "authenticate",
    value: function authenticate(id, secret, ttl) {
      var _this = this;
      ...
      var request = new _isomorphicFetch2.default.Request(uri, {
        method: "POST",
        mode: "cors",
        headers: new Headers({
    ...
    value: function fileUpload(resourceId, file, stream) {
      var request = new _isomorphicFetch2.default.Request(this.config.commandServer + "/commandSync/resource/" + resourceId + "/upload", {
        method: "POST",
        mode: "cors",
        headers: new Headers({
          "Authorization": "Bearer " + this.accessToken,
    ...
    */
    ...
    value: function getDistinct(datasetId, key, filter, projection, options) {
      var request = _helpers.buildQueryRequest.call(this, "datasets/" + datasetId + "/distinct?key=" + key, filter, projection, options);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
