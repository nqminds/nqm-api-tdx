...
var TDXApi = function () {
  ...
  _createClass(TDXApi, [{
    ...
    */
    ...
    value: function exchangeTDXToken(token, validateIP, exchangeIP) {
      var request = _helpers.buildQueryRequest.call(this, "token/exchange", { token: token, ip: validateIP, exchangeIP: exchangeIP });
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
