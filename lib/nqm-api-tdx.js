  ...
  _createClass(TDXApi, [{
    ...
    value: function addAccount(options, wait) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        if (wait) {
          if (options.accountType === _nqmCoreUtils.constants.userAccountType) {
            var userGroupsFolderId = (0, _nqmCoreUtils.shortHash)(_nqmCoreUtils.constants.accountSetRootFolderPrefix + result.response.username);
            return _helpers.waitForIndex.call(_this2, userGroupsFolderId).then(function () {
              return result;
            });
          } else {
