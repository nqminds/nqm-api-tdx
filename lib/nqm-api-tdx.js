...
var TDXApi = function () {
  ...
  _createClass(TDXApi, [{
    ...
    value: function buildCommandRequest(command, data, contentType) {
    ...
    value: function buildQueryRequest(prefix, filter, projection, options) {
    ...
    value: function updateAccount(username, options) {
      var request = this.buildCommandRequest("account/update", _extends({ username: username }, options));
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function approveAccount(username, approved) {
      var request = this.buildCommandRequest("account/approve", { username: username, approved: approved });
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function resetAccount(username, key) {
      var request = this.buildCommandRequest("account/reset", { username: username, key: key });
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function verifyAccount(username, verified) {
      var request = this.buildCommandRequest("account/verify", { username: username, verified: verified });
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function deleteAccount(username) {
      var request = this.buildCommandRequest("account/delete", { username: username });
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function moveResource(id, fromParentId, toParentId) {
      var request = this.buildCommandRequest("resource/move", { id: id, fromParentId: fromParentId, toParentId: toParentId });
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function rebuildResourceIndex(resourceId) {
      ...
      var request = this.buildCommandRequest("resource/index/rebuild", { id: resourceId });
      var result = void 0;
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
        ...
        result = res;
        return _this3.waitForIndex(result.response.id, "built");
      }).then(function () {
        return result;
      });
    }
    ...
    value: function suspendResourceIndex(resourceId) {
      ...
      var request = this.buildCommandRequest("resource/index/suspend", { id: resourceId });
      var result = void 0;
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
        ...
        result = res;
        return _this4.waitForIndex(result.response.id, "suspended");
      }).then(function () {
        return result;
      });
    }
    ...
    value: function truncateResource(resourceId) {
      var request = this.buildCommandRequest("resource/truncate", { id: resourceId });
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function addData(datasetId, data) {
      ...
      var request = this.buildCommandRequest("dataset/data/createMany", postData);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function deleteDataByQuery(datasetId, query) {
      ...
      var request = this.buildCommandRequest("dataset/data/deleteQuery", postData);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function fileUpload(resourceId, file, stream) {
      var request = new Request(this.config.commandHost + "/commandSync/resource/" + resourceId + "/upload", {
        method: "POST",
        mode: "cors",
        headers: new Headers({
          "Authorization": "Bearer " + this.accessToken,
      ...
      var response = (0, _isomorphicFetch2.default)(request).catch(function (err) {
      ...
      if (stream) {
        ...
        return response.then(function (response) {
          ...
          if (response.ok) {
            return _bluebird2.default.resolve(text);
          } else {
            return _bluebird2.default.reject((0, _helpers.handleError)("fileUpload", { code: "failure", message: text }));
          }
        });
      }
    }
    ...
    value: function startDatabotInstance(databotId, payload) {
      ...
      var request = this.buildCommandRequest("databot/startInstance", postData);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function stopDatabotInstance(instanceId, mode) {
      ...
      var request = this.buildCommandRequest("databot/stopInstance", postData);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function deleteDatabotInstance(instanceId) {
      ...
      var request = this.buildCommandRequest("databot/deleteInstance", postData);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function sendDatabotHostCommand(command, hostId, hostIp, hostPort) {
      ...
      var request = this.buildCommandRequest("databot/host/command", postData);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function getDistinct(datasetId, key, filter, projection, options) {
      var request = this.buildQueryRequest("datasets/" + datasetId + "/distinct?key=" + key, filter, projection, options);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
    ...
    value: function getTDXToken(tdx) {
      var request = this.buildQueryRequest("tdx-token/" + tdx);
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
      ...
      return this.getResource(resourceId).then(function (resource) {
        ...
        if (!checkResult) {
          ...
          return _bluebird2.default.delay(pollingInterval).then(function () {
            return _this5.waitForResource(resourceId, check, retryCount + 1, maxRetries);
          });
        } else {
          return resource;
        }
