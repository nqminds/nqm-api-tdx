...
exports.setDefaults = exports.checkResponse = undefined;
...
var TDXApi = function () {
  function TDXApi(config) {
    ...
    _helpers2.default.setDefaults(this.config);
  }
  ...
  _createClass(TDXApi, [{
    ...
    value: function authenticate(id, secret) {
      ...
      return (0, _isomorphicFetch2.default)(request).then(_helpers2.default.checkResponse).then(function (result) {
        log(result);
    ...
    value: function addAccount(options) {
      ...
      }).then(_helpers2.default.checkResponse);
    }
  }, {
    ...
    value: function addResource(options, wait) {
      ...
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
        ...
        return _bluebird2.default.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers2.default.checkResponse).then(function (result) {
        if (wait) {
          return _this2.waitForIndex(result.response.id).return(result);
        } else {
          return result;
        }
      });
      ...
      return this.getDataset(datasetId).then(function (dataset) {
        ...
        if (!checkResult) {
          ...
          return _bluebird2.default.delay(pollingInterval).then(function () {
            return _this3.waitForResource(datasetId, check, retryCount + 1, maxRetries);
          });
        } else {
          return dataset;
        }
