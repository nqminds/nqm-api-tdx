(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@nqminds/nqm-core-utils"), require("debug"), require("base-64"), require("cross-fetch"));
	else if(typeof define === 'function' && define.amd)
		define("nqm-api-tdx", ["@nqminds/nqm-core-utils", "debug", "base-64", "cross-fetch"], factory);
	else if(typeof exports === 'object')
		exports["nqm-api-tdx"] = factory(require("@nqminds/nqm-core-utils"), require("debug"), require("base-64"), require("cross-fetch"));
	else
		root["nqm-api-tdx"] = factory(root["@nqminds/nqm-core-utils"], root["debug"], root["base-64"], root["cross-fetch"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_5__) {
...
var _nqmCoreUtils = __webpack_require__(0);
  ...
  return this.getAccount(accountId).then(function (account) {
    ...
    if (account && account.initialised) {
      ...
      if (verified && !account.verified) {
        ...
        if ((0, _nqmCoreUtils.splitTDXAccount)(accountId)) {
          //
          ...
          var accountSetFolderId = _nqmCoreUtils.resourceUtils.specialFolderId(_nqmCoreUtils.constants.accountSetRootFolderPrefix, accountId);
          return waitForIndex.call(_this3, accountSetFolderId, "built", maxRetries).then(function () {
            return account;
          });
        } else {
