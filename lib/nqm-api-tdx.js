...
var TDXApiError = function TDXApiError(code, failure, source, stack) {
  // Build a string summary for legacy or non-json clients.
  var stringVersion = JSON.stringify({
    from: source,
 ...
 */
var handleError = function handleError(code, failure, source) {
...
var checkResponse = function checkResponse(source, doNotThrow, response) {
  var log = (0, _debug2.default)("nqm-api-tdx:checkResponse");
  ...
  return response.text().then(function (text) {
    ...
    if (response.ok) {
      ...
      if (jsonResponse && jsonResponse.error) {
        ...
        var failure = { code: jsonResponse.error, message: jsonResponse.error_description };
...
var TDXApi = function () {
  ...
  _createClass(TDXApi, [{
    ...
    value: function updateAccount(username, options) {
      var request = _helpers.buildCommandRequest.call(this, "account/update", Object.assign({ username: username }, options));
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
    ...
    value: function addResource(options, wait) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        if (wait) {
          return _helpers.waitForIndex.call(_this4, result.response.id, wait === true ? "" : wait).then(function () {
            return result;
          });
        } else {
          return result;
    ...
    value: function fileUpload(resourceId, file, stream) {
      ...
      if (stream) {
        ...
        return response.then(_helpers.checkResponse.bind(this, "fileUpload"));
      }
    }
    ...
    key: "setResourceImporting",
    value: function setResourceImporting(resourceId, importing) {
      var request = _helpers.buildCommandRequest.call(this, "resource/importing", { id: resourceId, importing: importing });
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        errLog("TDXApi.setResourceImporting: %s", err.message);
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(this, "setResourceImporting"));
    }
    ...
    key: "setResourceStore",
    value: function setResourceStore(resourceId, store, storeSize) {
      var request = _helpers.buildCommandRequest.call(this, "resource/store/set", {
        id: resourceId,
        store: store,
        storeSize: storeSize
      });
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(this, "setResourceStore"));
    }
    ...
    value: function updateResource(resourceId, update) {
      var request = _helpers.buildCommandRequest.call(this, "resource/update", Object.assign({ id: resourceId }, update));
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
    ...
    value: function patchData(datasetId, data, doNotThrow) {
      ...
      var request = _helpers.buildCommandRequest.call(this, "dataset/data/patchMany", postData);
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
    ...
    key: "updateData",
    value: function updateData(datasetId, data, upsert, doNotThrow, opts) {
      var postData = {
        datasetId: datasetId,
        payload: [].concat(data),
        __upsert: !!upsert,
    ...
    key: "abortDatabotInstance",
    value: function abortDatabotInstance(instanceId) {
      var postData = {
        instanceId: instanceId
      };
      var request = _helpers.buildCommandRequest.call(this, "databot/abortInstance", postData);
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        errLog("TDXApi.abortDatabotInstance: %s", err.message);
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(this, "abortDatabotInstance"));
    }
    ...
    value: function getAccounts(filter) {
      var request = _helpers.buildQueryRequest.call(this, "accounts", filter);
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        errLog("TDXApi.getAccounts: %s", err.message);
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(this, "getAccounts"));
    }
    ...
    key: "getNDData",
    value: function getNDData(datasetId, filter, projection, options) {
      return this.getDataStream(datasetId, filter, projection, options, true).then(_helpers.checkResponse.bind(this, "getNDData"));
    }
