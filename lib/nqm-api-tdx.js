(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("debug"), require("@nqminds/nqm-core-utils"), require("base-64"), require("@nqminds/isomorphic-fetch"), require("bluebird"));
	else if(typeof define === 'function' && define.amd)
		define("nqm-api-tdx", ["debug", "@nqminds/nqm-core-utils", "base-64", "@nqminds/isomorphic-fetch", "bluebird"], factory);
	else if(typeof exports === 'object')
		exports["nqm-api-tdx"] = factory(require("debug"), require("@nqminds/nqm-core-utils"), require("base-64"), require("@nqminds/isomorphic-fetch"), require("bluebird"));
	else
		root["nqm-api-tdx"] = factory(root["debug"], root["@nqminds/nqm-core-utils"], root["base-64"], root["@nqminds/isomorphic-fetch"], root["bluebird"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__) {
...
exports.waitForIndex = exports.waitForAccount = exports.TDXApiError = exports.setDefaults = exports.handleError = exports.fetchWithDeadline = exports.checkResponse = exports.buildQueryRequest = exports.buildDatabotInstanceRequest = exports.buildDatabotHostRequest = exports.buildCommandRequest = undefined;
...
var fetchWithDeadline = function fetchWithDeadline(request) {
  ...
  return new _bluebird2.default(function (resolve, reject) {
    ...
    _bluebird2.default.resolve((0, _isomorphicFetch2.default)(request)).then(function (response) {
      // Forward response.
      resolve(response);
    }).catch(function (err) {
      if (!rejected) {
...
var waitForAccount = function waitForAccount(accountId, verified, approved, retryCount, maxRetries) {
  ...
  return this.getAccount(accountId).then(function (account) {
    ...
    if (retry) {
      ...
      if (maxRetries >= 0 && retryCount > maxRetries) {
        log("giving up after %d attempts", retryCount);
        return _bluebird2.default.reject(new Error("gave up waiting for " + accountId + " after " + retryCount + " attempts"));
      }
...
var TDXApi = function () {
  ...
  _createClass(TDXApi, [{
    ...
    value: function addAccount(options, wait) {
      ...
      }).then(_helpers.checkResponse.bind(null, "addAccount")).then(function (result) {
        if (wait) {
    ...
    value: function addAccountApplicationConnection(accountId, applicationId, wait) {
      var _this3 = this;
      ...
      return this.getResource(applicationId).then(function (app) {
        if (!app) {
        ...
        // Get user details.
        return _this3.getAccount(accountId);
      }).then(function (usr) {
        if (!usr) {
        ...
        return _this3.getResource(applicationUserId);
      }).then(function (existing) {
        if (!existing) {
          // Parent folder is the users "application data" folder
          var applicationDataFolderId = _nqmCoreUtils.resourceUtils.specialFolderId(_nqmCoreUtils.constants.applicationDataFolderPrefix, user.owner);
          ...
          var connectionResource = {
            ...
            "basedOnSchema": _nqmCoreUtils.constants.groupResourceType,
            "shareMode": _nqmCoreUtils.constants.trustedShareMode,
            "parentId": applicationDataFolderId
          };

          return _this3.addResource(connectionResource, wait);
        } else {
        ...
        if (!existing) {
          ...
          return _this3.addResource(connectionResource);
        } else {
          return Promise.resolve(existing);
        }
        ...
        return _this3.addResourceAccess(applicationUserId, application.id, applicationUserId, [_nqmCoreUtils.constants.readAccess, _nqmCoreUtils.constants.writeAccess]);
      }).then(function (result) {
        log("add application access to user connection - result: %j", result);

        if (user.accountType !== _nqmCoreUtils.constants.userAccountType) {
          ...
          return _this3.addResourceAccess(applicationUserId, user.username, applicationUserId, [_nqmCoreUtils.constants.readAccess, _nqmCoreUtils.constants.writeAccess]);
        } else {
        ...
        var applicationUserGroupId = (0, _nqmCoreUtils.shortHash)(_nqmCoreUtils.constants.applicationServerUserGroupPrefix + application.id);
        return _this3.addResourceAccess(applicationUserGroupId, user.username, applicationUserGroupId, [_nqmCoreUtils.constants.readAccess]);
      });
    }
    ...
    value: function fileUpload(resourceId, file, stream) {
      ...
      var request = new Request(this.config.commandServer + "/commandSync/resource/" + resourceId + "/" + endPoint, {
        method: "POST",
        mode: "cors",
        headers: new Headers({
          "Authorization": "Bearer " + this.accessToken,
    ...
    */
    ...
    value: function addData(datasetId, data) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "addData"));
    }
    ...
    value: function addZoneConnection(options) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "addZoneConnection"));
    }
    ...
    value: function deleteZoneConnection(id) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "deleteZoneConnection"));
    }
    ...
    value: function rollbackCommand(id) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "rollbackCommand"));
    }
    ...
    value: function exchangeTDXToken(token, validateIP, exchangeIP, ttl) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "exchangeTDXToken"));
    }
    ...
    value: function getAccount(accountId) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "getAccount")).then(function (accountList) {
    ...
    */
    ...
    value: function getAggregateDataStream(datasetId, pipeline, ndJSON) {
      ...
      var endpoint = "datasets/" + datasetId + "/" + (ndJSON ? "ndaggregate" : "aggregate") + "?pipeline=" + pipeline;
    ...
    value: function getAggregateData(datasetId, pipeline, ndJSON) {
      return this.getAggregateDataStream(datasetId, pipeline, ndJSON).then(_helpers.checkResponse.bind(null, "getAggregateData"));
    }
    ...
    value: function getAuthenticatedAccount() {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "getAuthenticatedAccount"));
    }
    ...
    value: function getDataStream(datasetId, filter, projection, options, ndJSON) {
      var endpoint = "datasets/" + datasetId + "/" + (ndJSON ? "nddata" : "data");
    ...
    value: function getData(datasetId, filter, projection, options, ndJSON) {
      return this.getDataStream(datasetId, filter, projection, options, ndJSON).then(_helpers.checkResponse.bind(null, "getData"));
    }
    ...
    value: function validateTDXToken(token, ip) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "validateTDXToken"));
    }
  }]);
