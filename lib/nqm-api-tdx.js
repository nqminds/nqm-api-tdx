...
var _nqmCoreUtils2 = _interopRequireDefault(_nqmCoreUtils);
...
var TDXApi = function () {
  ...
  _createClass(TDXApi, [{
    ...
    value: function addAccountApplicationConnection(accountId, applicationId, wait) {
      ...
      var request = _helpers.buildCommandRequest.call(this, "account/connectApplication", { accountId: accountId });
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        errLog("TDXApi.addAccountApplicationConnection: %s", err.message);
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "addAccountApplicationConnection")).then(function (result) {
        if (wait) {
          var applicationUserId = _nqmCoreUtils2.default.shortHash(applicationId + "-" + accountId);
    ...
    */
    ...
    value: function getAccount(accountId) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "getZone")).then(function (zoneList) {
