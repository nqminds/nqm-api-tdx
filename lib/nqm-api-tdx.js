...
var TDXApi = function () {
  ...
  _createClass(TDXApi, [{
    ...
    value: function authenticate(id, secret) {
      ...
      return (0, _isomorphicFetch2.default)(request).then(_helpers.checkResponse).then(function (result) {
        log(result);
    ...
    value: function addResource(options, wait) {
      ...
      return (0, _isomorphicFetch2.default)(request).catch(function (err) {
        ...
        return _bluebird2.default.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse).then(function (result) {
        if (wait) {
    ...
    value: function waitForResource(datasetId, check, retryCount, maxRetries) {
      ...
      return this.getResource(datasetId).then(function (dataset) {
