...
exports.waitForIndex = exports.TDXApiError = exports.setDefaults = exports.handleError = exports.checkResponse = exports.buildQueryRequest = exports.buildCommandRequest = undefined;
...
var setDefaults = function setDefaults(config) {
  ...
  if (config.tdxServer && (!config.queryServer || !config.commandServer)) {
    ...
    log("defaulted hosts to %s, %s, %s", config.commandServer, config.queryServer, config.databotServer);
  }
};
