(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("debug"), require("@nqminds/nqm-core-utils"), require("base-64"), require("bluebird"), require("cross-fetch"));
	else if(typeof define === 'function' && define.amd)
		define("nqm-api-tdx", ["debug", "@nqminds/nqm-core-utils", "base-64", "bluebird", "cross-fetch"], factory);
	else if(typeof exports === 'object')
		exports["nqm-api-tdx"] = factory(require("debug"), require("@nqminds/nqm-core-utils"), require("base-64"), require("bluebird"), require("cross-fetch"));
	else
		root["nqm-api-tdx"] = factory(root["debug"], root["@nqminds/nqm-core-utils"], root["base-64"], root["bluebird"], root["cross-fetch"]);
...
var _crossFetch = __webpack_require__(6);
...
var FetchRequest = _crossFetch2.default.Request || Request;
var FetchHeaders = _crossFetch2.default.Headers || Headers;
...
var fetchWithDeadline = function fetchWithDeadline(request) {
  ...
  return new _bluebird2.default(function (resolve, reject) {
    ...
    _bluebird2.default.resolve((0, _crossFetch2.default)(request)).then(function (response) {
      // Forward response.
      resolve(response);
    }).catch(function (err) {
      if (!rejected) {
...
var waitForAccount = function waitForAccount(accountId, verified, approved, retryCount, maxRetries) {
  ...
  return this.getAccount(accountId).then(function (account) {
    ...
    if (retry) {
      ...
      if (maxRetries >= 0 && retryCount > maxRetries) {
        log("giving up after %d attempts", retryCount);
        return _bluebird2.default.reject(new Error("gave up waiting for account " + accountId + " after " + retryCount + " attempts"));
      }
    ...
    */
    ...
    value: function createTDXToken(username, ip, ttl) {
      ...
      return _helpers.fetchWithDeadline.call(this, request).catch(function (err) {
        ...
        return Promise.reject(new Error(err.message + " - [network error]"));
      }).then(_helpers.checkResponse.bind(null, "createTDXToken"));
    }
