(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("base-64"), require("bluebird"), require("debug"), require("isomorphic-fetch"));
	else if(typeof define === 'function' && define.amd)
		define("nqm-api-tdx", ["base-64", "bluebird", "debug", "isomorphic-fetch"], factory);
	else if(typeof exports === 'object')
		exports["nqm-api-tdx"] = factory(require("base-64"), require("bluebird"), require("debug"), require("isomorphic-fetch"));
	else
		root["nqm-api-tdx"] = factory(root["base-64"], root["bluebird"], root["debug"], root["isomorphic-fetch"]);
