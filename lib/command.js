module.exports = (function() {
  ...
  var deleteDatasetData = function(datasetId, primaryKey, keyValue, cb) {
    log("deleteDatasetData");
    var postData = {
      datasetId: datasetId,
    };
    postData[primaryKey] = keyValue;
    return this._commandPost.call(this,"dataset/data/delete", postData, cb);
  }
